...
from iris.testing.controller import FakeProvider, make_controller_service, make_test_entrypoint
...
def make_service_test_harness(provider_type: str, tmp_path, log_address: str) -> ServiceTestHarness:
    """Build a resource service harness for the requested provider."""
