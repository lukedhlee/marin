...
sbatch \
  -J snowball-chat-sweep-v2 \
  -o "${S}/logs/snowball-chat-sweep-v2.%j.log" \
  --export=ALL,\
MARIN_ROOT="${S}/marin",\
...
SNOWBALL_OUTPUT_ROOT="${S}/experiments/snowball-chat-vista/sweep-v2",\
SNOWBALL_PROD_OUTPUT="${S}/experiments/snowball-chat-vista/chat-257-r8",\
SNOWBALL_PROD_RUN_ID=snowball-chat-r8,\
SMOKE_TIMEOUT=1200,PROBE_MIN_STEPS=6 \
