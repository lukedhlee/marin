...
sbatch \
  -J snowball-chat-cbfix-r7 \
  -o "${S}/logs/snowball-chat-cbfix-r7.%j.log" \
  --export=ALL,\
MARIN_ROOT="${S}/marin",\
...
SNOWBALL_SMOKE_OUTPUT="${S}/experiments/snowball-chat-vista/chat-smoke-r7",\
SNOWBALL_SMOKE_RUN_ID=snowball-chat-smoke-r7,\
SNOWBALL_OUTPUT="${S}/experiments/snowball-chat-vista/chat-257-r5",\
SNOWBALL_RUN_ID=snowball-chat-r5 \
