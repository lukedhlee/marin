...
3. Confirm the control and treatment completed the same execution and stage
   set.
4. Inspect `iris task list --job <IRIS_JOB_ID>` and relevant `task describe`
   results for OOMs and Attempt failures; use the Finelog query for peak memory.
